            ...
            <div className="row fullscreen">
              <div className="banner-content col-lg-6 col-md-12 justify-content-center d-flex flex-direction-column align-items-center ">
                <div>
                  ...
                  <h1 className="wow fadeInDown" data-wow-duration="1s">
                    GEORGE <span className="bibi">BIBI</span>LASHVILI
                  </h1>
                  <div
                    className="designation mb-70 wow fadeInDown"
